...
class NoSuchSessionException(WebDriverException):
    """ Thrown when session could not be found.

    If you encounter this exception, you may want to check the following:
        * Make sure webdriver service is up and running
    """
    pass
...
UnhandledAlertException = UnexpectedAlertPresentException
...
class RemoteDriverServerException(WebDriverException):
    """ Thrown when a remote driver server throws an exception. """
    pass
...
ScriptTimeoutException = JavascriptException
...
class UnsupportedCommandException(WebDriverException):
    """ The requested command did not match any existing commands """
    pass
