...
class Command(object):
    ...
    ELEMENT_GET_ANONYMOUS_CHILDREN = "ELEMENT_GET_ANONYMOUS_CHILDREN"
    ELEMENT_FIND_ANONYMOUS_ELEMENTS_BY_ATTRIBUTE = "ELEMENT_FIND_ANONYMOUS_ELEMENTS_BY_ATTRIBUTE"
